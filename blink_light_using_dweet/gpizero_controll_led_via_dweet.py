...
thing_name = None  # Thing name, generated in `resolve_thing_name`
            ...
            for line in response.iter_content(chunk_size=None):
                if line:
                    try:
                        ...
                        dweet = json.loads(
                            eval(json_str)
                        )  # json_str is a string in a string.
                        ...
                        logger.error(
                            "Failed to process and parse dweet json string %s", json_str
                        )
